...
if __name__ == '__main__':
    ...
    # number of slices from 1 flipbook to next
    flipbook_span = attr_csv['start'].values[1] - attr_csv['start'].values[0]
    ...
    for flipbook_s,flipbook_e in zip(sindices, eindices):
        ...
        if args.flipbook:
            image_stack_s = flipbook_s * flipbook_span
            image_stack_e = flipbook_e * flipbook_span
        else:
